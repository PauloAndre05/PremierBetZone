    ...
    return (
        <div className="max-w-screen-xl mx-auto py-20">
            <div className="w-full flex gap-6">
                <div className="w-48 flex flex-col justify-center items-center mt-[10px]">
                ...
                <div className="flex flex-col gap-4">
						<div className="flex flex-col gap-4">
							<h3 className="text-bold text-[16px] text-[#00000080] font-[Montserrat]">
								COMO FUNCIONA
							</h3>

							<h1 className="font-bold text-[30px] text-[#E37A00] flex items-center gap-2">
...
"
                    ...
                    <div className="flex h-[550px] justify-center items-center w-[50%] rounded-lg overflow-hidden shadow-md">
